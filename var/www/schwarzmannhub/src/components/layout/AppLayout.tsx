...
import { Home, CalendarDays, LayoutDashboard, Zap, Bell, LogOut, ShieldCheck, Newspaper, BellRing, BellOff } from "lucide-react";
...
const UserMenu = () => {
  ...
  const { isSubscribed, subscribe, unsubscribe, isSupported, permission } = usePushManager();
